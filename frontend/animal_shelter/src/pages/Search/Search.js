...
const mockAnimals = [
    {
      ...
      photo_url: "https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?q=80&w=300"
    },
    {
      article_id: 2,
      name: "Рекс",
      ...
      photo_url: "https://images.unsplash.com/photo-1543466835-00a7907e9de1?q=80&w=300"
    },
    {
      article_id: 3,
      name: "Мурка",
      ...
      photo_url: "https://images.unsplash.com/photo-1548802673-380ab8ebc7b7?q=80&w=300"
    },
    {
      article_id: 4,
      name: "Шарік",
      ...
      shelter_id: "Щасливий хвіст",
      photo_url: "https://images.unsplash.com/photo-1537151608828-ea2b11777ee8?q=80&w=300"
    },
    {
      article_id: 5,
      name: "Ліза",
      ...
      health_status: "Здоровий",
      shelter_id: "Кіт і Кіт",
      photo_url: "https://images.unsplash.com/photo-1533738363-b7f9aef128ce?q=80&w=300"
    },
    {
      article_id: 7,
      name: "Стрілка",
      ...
      health_status: "З особливостями",
      shelter_id: "Щасливий хвіст",
      photo_url: "https://images.unsplash.com/photo-1583337130417-3346a1be7dee?q=80&w=300"
    },
    {
      article_id: 8,
      name: "Сімба",
      ...
      health_status: "Здоровий",
      shelter_id: "Кіт і Кіт",
      photo_url: "https://images.unsplash.com/photo-1573865526739-10659fec78a5?q=80&w=300"
    }
  ];
  ...
  const applyFilters = () => {
    ...
    if (filters.age !== 'all') {
      result = result.filter(animal => {
        ...
        if (filters.age === 'adult' && animal.age >= 1 && animal.age <= 2) return true;
        if (filters.age === 'senior' && animal.age > 2 && animal.age <= 5) return true;
    ...
    if (filters.health !== 'all') {
      result = result.filter(animal => animal.health_status === filters.health);
    }
      ...
      <div className="filters">
        ...
        <div className="filter-group">
          ...
          <div className="filter-options">
            <button 
              className={`filter-tag ${filters.gender === 'all' ? 'active' : ''}`}
              onClick={() => onFilterChange('gender', 'all')}
            >
              Усі
            </button>
            <button 
              className={`filter-tag ${filters.gender === 'Хлопчик' ? 'active' : ''}`}
              onClick={() => onFilterChange('gender', 'Хлопчик')}
            >
              Хлопчик
            </button>
            <button 
              className={`filter-tag ${filters.gender === 'Дівчинка' ? 'active' : ''}`}
        ...
        <div className="filter-group">
          ...
          <div className="filter-options">
            ...
            <button 
              className={`filter-tag ${filters.age === 'young' ? 'active' : ''}`}
              onClick={() => onFilterChange('age', 'young')}
            >
              До 1р
            </button>
            <button 
              className={`filter-tag ${filters.age === 'adult' ? 'active' : ''}`}
              onClick={() => onFilterChange('age', 'adult')}
            >
              1-2р
            </button>
            <button 
              className={`filter-tag ${filters.age === 'senior' ? 'active' : ''}`}
              onClick={() => onFilterChange('age', 'senior')}
            >
              2-5р
            </button>
            <button 
              className={`filter-tag ${filters.age === 'elder' ? 'active' : ''}`}
        ...
        <div className="filter-group">
          ...
          <div className="filter-options">
            <button 
              className={`filter-tag ${filters.health === 'all' ? 'active' : ''}`}
              onClick={() => onFilterChange('health', 'all')}
            >
              Усі
            </button>
            <button 
              className={`filter-tag ${filters.health === 'З особливостями' ? 'active' : ''}`}
              onClick={() => onFilterChange('health', 'З особливостями')}
            >
              З особливостями
            </button>
            <button 
              className={`filter-tag ${filters.health === 'Потребує лікування' ? 'active' : ''}`}
              onClick={() => onFilterChange('health', 'Потребує лікування')}
            >
              Потребує лікування
            </button>
            <button 
              className={`filter-tag ${filters.health === 'Здоровий' ? 'active' : ''}`}
